...
| `skillsets/pr-review/` | A user wants `/code-review`, high-signal PR review, diff review, merge readiness, public review comments, PR bodies, or AI-generated PR review | Mandatory output-contract load, preflight decision, scoped instruction map, validated findings, inline root-cause thread plan, practical failure examples, safe suggestion blocks, dropped candidates, posting mode, concise PR body contract, operator validation, and residual risk |
