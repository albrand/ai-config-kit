...
- Outcome evidence: each required outcome names the observed result, evidence reference, candidate/environment and limitation; do not omit failed or unverified outcomes. Keep internal evidence private where posting rules require it.
- Evidence freshness: replace affected observations after edits; a screenshot filename does not prove that someone inspected its pixels.
- Claim separation: functional, visual, usability, deployed, and accepted reported as distinct states (`DELIVERY_QUALITY.md`).
...
Artifacts: ...
Validation: ...
Evidence binding: candidate version + environment ...
