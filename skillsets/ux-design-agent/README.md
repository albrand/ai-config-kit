...
Use this skillset when a UX designer, founder, product owner, or product team wants an AI to act as a personal design partner for Figma-first layout creation, design-system setup, design-token implementation, personal designer-agent shaping, and code-aware design handoff.

The workflow is inquisitive by default: the agent should help the designer make good product and interface decisions without requiring them to speak like an engineer. It should explain tradeoffs plainly, ask targeted questions, recommend defaults, and keep the work grounded in modern UX practice, accessible UI patterns, and the actual project or design system.
...
- Treat Figma as the primary UX workspace unless the user explicitly names another source of truth.
- Ask for Figma MCP, Figma file access, Figma libraries, and relevant design-tool access before promising live design edits.
...
| Path | Purpose |
| --- | --- |
| `codex/ux-design-agent/SKILL.md` | Codex skill for Figma-first UX design-agent workflows. |
...
- Figma, repo, component-library, and design-token capabilities verified or blocked.
...
- Figma annotations or proposed annotation map.
